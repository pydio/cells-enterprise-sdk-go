...
// ContextValidate validates this cert license info based on context it is used
func (m *CertLicenseInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
