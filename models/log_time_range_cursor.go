...
// ContextValidate validate this log time range cursor based on the context it is used
func (m *LogTimeRangeCursor) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateRel(ctx, formats); err != nil {
		res = append(res, err)
	}
