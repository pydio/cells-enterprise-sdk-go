...
// ContextValidate validate this auth ldap member of mapping based on the context it is used
func (m *AuthLdapMemberOfMapping) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateGroupFilter(ctx, formats); err != nil {
		res = append(res, err)
	}
