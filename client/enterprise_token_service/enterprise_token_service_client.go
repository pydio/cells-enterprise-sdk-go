...
func (a *Client) GeneratePersonalAccessToken(params *GeneratePersonalAccessTokenParams, opts ...ClientOption) (*GeneratePersonalAccessTokenOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for GeneratePersonalAccessToken: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ImpersonatePersonalAccessToken(params *ImpersonatePersonalAccessTokenParams, opts ...ClientOption) (*ImpersonatePersonalAccessTokenOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ImpersonatePersonalAccessToken: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ListPersonalAccessTokens(params *ListPersonalAccessTokensParams, opts ...ClientOption) (*ListPersonalAccessTokensOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ListPersonalAccessTokens: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) RevokePersonalAccessToken(params *RevokePersonalAccessTokenParams, opts ...ClientOption) (*RevokePersonalAccessTokenOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for RevokePersonalAccessToken: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
