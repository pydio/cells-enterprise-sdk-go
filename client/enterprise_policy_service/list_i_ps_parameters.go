...
// WithName adds the name to the list i ps params
func (o *ListIPsParams) WithName(name string) *ListIPsParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the list i ps params
func (o *ListIPsParams) SetName(name string) {
	o.Name = name
}
