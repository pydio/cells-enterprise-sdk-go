...
// WithDefaults hydrates default values in the put job params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutJobParams) WithDefaults() *PutJobParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put job params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutJobParams) SetDefaults() {
