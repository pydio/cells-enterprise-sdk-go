...
// WithDefaults hydrates default values in the license stats params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LicenseStatsParams) WithDefaults() *LicenseStatsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the license stats params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LicenseStatsParams) SetDefaults() {
